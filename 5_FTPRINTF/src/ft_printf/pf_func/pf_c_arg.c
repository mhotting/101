...
/*   Updated: 2018/11/30 16:53:51 by mhotting    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static void	ft_applyflag1(char **res, t_attributes *att, char c)
{
	...
	{
		if (att->opt1 == 1)
			ft_enhance_right(res, ' ', (c == '\0' ? att->width + ft_strlen("@@+NULL+@@") - 1 : att->width));
		else
			ft_enhance_left(res, ' ', (c == '\0' ? att->width + ft_strlen("@@+NULL+@@") - 1 : att->width));
	}
}
